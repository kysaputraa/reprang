                    ...
                    <div class="mx-auto app-login-box col-md-8">
                        <!-- <div class="app-logo-inverse mx-auto mb-3"></div> -->
                            <div class="modal-dialog w-100 mx-auto">
                                <form  method="post" enctype="multipart/form-data" action="<?php echo base_url('login/cek') ?>">
                        ...
                        <div class="text-center text-white opacity-8 mt-3">Copyright ©KYSA 2020</div>
                    </div>
                </div>
            </div>
        </div>
