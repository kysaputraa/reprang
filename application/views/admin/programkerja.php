<?php if ($isi == 'list_programkerja'){  ?>
    ...
    <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
        <li class="nav-item">
            <a href="<?php echo base_url('admin/programkerja/tambah'); ?>" role="tab" class="nav-link active" id="tab-0" >
            ...
            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                ...
                <tbody>
                	<?php $no = 1; foreach ($programkerja as $row){
                        ...
                        echo "<td><a href='".base_url('admin/programkerja/edit/').$row->id."'>";
                		  echo "<button class='mb-2 mr-2 btn btn-shadow btn-warning'> Edit </button>";
                        echo "</a>";
                        echo "<a href='".base_url('admin/programkerja/hapus/').$row->id."'>";
...
<?php } elseif ($isi == 'tambah') { ?>
    ...
    <div class="main-card mb-3 card">
        <div class="card-body"><h5 class="card-title">Silahkan Masukkan data di bawah ini untuk menambah programkerja !</h5>
            <form method="post" action="<?php echo base_url('admin/programkerja/tambah'); ?>" enctype="multipart/form-data">
                <!-- <div class="form-row">
                    <div class="col-md-6">
            ...
            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                ...
                <tbody>
                    <?php $no = 1; foreach ($programkerja as $row){
                        ...
                        echo "<td>".$row->nama_sub."</td>";
                        echo "<td>".$row->keterangan."</td>";
                        echo "<td><a href='".base_url('admin/programkerja/setuju/').$row->id."'>";
                          echo "<button class='mb-2 mr-2 btn btn-shadow btn-success'> Setuju </button>";
                        echo "</a>";
                        echo "<a href='".base_url('admin/programkerja/hapus/').$row->id."'>";
                          echo "<button class='mb-2 mr-2 btn btn-shadow btn-danger'> Hapus </button>";
                        echo "</a></td>";
...
<?php } elseif ($isi == 'edit') { ?>
    ...
    <div class="main-card mb-3 card">
        <div class="card-body"><h5 class="card-title">Silahkan Masukkan data di bawah ini untuk menambah programkerja !</h5>
            <form method="post" action="<?php echo base_url('admin/programkerja/edit/').$data->id; ?>" enctype="multipart/form-data">
                <div class="form-row">
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            <label for="examplePassword11" class="">KEGIATAN <?php echo $this->session->userdata('id'); ?></label>
  ...
  $(document).ready(function(){
    $('.action').change(function(){
      if($(this).val() != ''){
        ...
        $.ajax({
        url: '<?php echo base_url('admin/programkerja/fetch'); ?>',
        method:"POST",
